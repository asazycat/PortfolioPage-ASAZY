    ...
    return (
        ...
        <div className="Projects">
            <div className="eachProject">
                <h2>Norcthcoders News Network (NC News) - Solo</h2>
                <div className="desImgFormat">
                <p>Project description</p>
                <img src="../src/imgs/articlesNCNews.jpg" alt="" width="800" height="600"/>
                </div>
                <div className="links">
                <p>
            ...
            <div className="eachProject">
                <h2>CodeClan - Group</h2>
                <div className="desImgFormat">
                <p>descritption</p>
                <img src="../src/imgs/codeClanDashBoard.jpg" alt=""  width="800" height="600"/>
                </div>
                <div className="links">
                <p>
            ...
            <div className="eachProject">
                ...
                <div className="desImgFormat">
                <p>Project description</p>
                <img src="../src/imgs/GamerCoreFeed.jpg" alt=""  width="800" height="600"/>
                </div>
                <div className="links">
                <p>
